...
Bundled highlight.pack.js is Copyright (c) 2006-2026 Josh Goebel <hello@joshgoebel.com> and other contributors,
licensed under the (three-clause) BSD License L<https://opensource.org/license/BSD-3-Clause>.

Bundled StackOverflow highlight themes are Copyright (c) Stack Exchange, Inc, licensed under the MIT License
