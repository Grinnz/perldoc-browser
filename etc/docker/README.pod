...
installation of the I<Perl> Modules for the SQLite Backend from the C<cpanfile> was executed at Image Build Time.
So on updates of the C<cpanfile> it is recommendable to rebuild the Container Image as described above
under B<IMAGE BUILD>.
